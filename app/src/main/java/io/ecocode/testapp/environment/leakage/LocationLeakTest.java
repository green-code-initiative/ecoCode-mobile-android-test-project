...
public class LocationLeakTest extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 1000L, 1.0f, getListener()); // Issue {Leakage: Location Leak}
